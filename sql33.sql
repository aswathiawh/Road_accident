...
insert  into `case`(`case_id`,`case_type`,`o_id`,`time`,`date`,`place`,`cid`,`rule`) values 
('klio234','accient',13,'00:00:09','2019-03-22','clt',1,'traffic'),
('asert56','accident',14,'00:00:03','2019-03-15','clt',2,'speed');
...
insert  into `criminal`(`ciminal_id`,`cid`,`name`,`age`,`address`,`phone`,`photo`,`gender`) values 
(1,1,'asw',34,'zxcvb','3639999','kkok','male');
...
insert  into `login`(`lid`,`type`,`username`,`password`) values 
(1,'admin','admin','admin'),
...
(17,'neethu','ghjklmnb','2019-02-20',30,'Female','mca','asdg@gmail.com','1236547890','ci','download_3.jpg',8);
...
CREATE TABLE `rules` (
  ...
  `rulevialted` varchar(50) DEFAULT NULL,
...
insert  into `rules`(`rid`,`rulevialted`,`vehicle`,`cid`) values 
(1,'traffic','bike',1);
...
insert  into `vehicle`(`vid`,`vtype`,`v_no`,`v_photo`,`owner`,`cid`) values 
(1,'bike','KL18989','jjjj','mani',1);
